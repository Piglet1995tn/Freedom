<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="FreedomeF.Request" %>
                                ...
                                <table class="table table-striped table-bordered table-list"> 
                                    ...
                                    <tbody>
                                        <tr>      
                                           <td>1</td>
                                           <td>SExxx</td> 
                                           <td><a href="" style="text-decoration: none">Ann@fpt.edu.vn</a></td> 
                                           <td>Gặp vấn đề khi học nhật</td>
                                           <td>3/06/2018</td>
                                            <td>Chưa xử lí</td>
